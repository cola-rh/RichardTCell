setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/RichardTCell")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/RichardTCell/RichardTCell_data.rds')
